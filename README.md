This is a re-imagination of the Carriable idea. This time I will build it in React, and instead of just displaying information, work to create a benchmark for each rank. That way I will be able to compare a users stats with their current rank, next rank, and ideal rank. Hopefully picking out the stats most important to each role will help understand where the most impactful improvements stand to be made.

Leaving the react readme because it's useful information and I'm still learning. Will update the ReadMe with progress once substantial progress has been made.
